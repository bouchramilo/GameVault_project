<footer class="bg-gradient-to-r from-[#450902] via-[#a53860] to-[#450902] py-10 px-10 font-sans tracking-wide">
      <div class="max-w-screen-xl mx-auto">
        <div class="flex flex-wrap items-center md:justify-between max-md:flex-col gap-6">
          <div>
            <a href='javascript:void(0)'><img src="images/logo_1.png" alt="logo" class='w-16 ' /></a>
          </div>
